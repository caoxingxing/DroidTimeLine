...
public class TimeLineView extends HorizontalListView {
	...
	public static class TimelineAdapter extends BaseAdapter {
		...
		public TimelineAdapter(Context mContext, int mStep, int mStartYear,
				int mEndYear, int mBackgroundColor, int mBackgroundResource,
				int mYearColor, int mIntervalWidth, boolean mUsesLines,
				int mLinesColor, int mLinesHeight, int mLinesCount,
				int mLinesWidth, int mYearSize) {
			super();
